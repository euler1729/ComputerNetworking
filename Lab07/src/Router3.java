...
public class Router3 {
    private static final String MULTICAST_ADDRESS2 = "224.0.0.2";//router 2,3
    private static final String MULTICAST_ADDRESS5 = "224.0.0.5";//router 3,5
    private static final int PORT2 = 3002;
    private static final int PORT5 = 3005;
    private static final int router_id = 3;
    private  static Network network = new Network();
    private static int msgId = 30000;
